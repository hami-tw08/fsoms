<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                @guest
                    <div class="flex items-center gap-3">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-sm text-white bg-gray-800 px-3 py-1.5 rounded-md hover:bg-gray-700">
                                {{ __('Register') }}
                            </a>
                        @endif
                    </div>
    ...
    <div id="mobile-menu" x-show="open" x-transition x-cloak class="sm:hidden">
